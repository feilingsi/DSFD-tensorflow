...
ap.add_argument( "--data_dir", required=True, default="", help="dir to img")
ap.add_argument( "--split_dir", required=True,default='',help="dir to FDDB-folds")
ap.add_argument( "--result", required=True,default='',help="dir to write result")
args = ap.parse_args()
...
#face_detector = FrcnnDetector(MODEL_PATH)
predictions = []
